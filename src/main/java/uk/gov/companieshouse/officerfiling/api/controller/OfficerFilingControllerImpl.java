...
@RestController
@RequestMapping(value = "/transactions/{trans-id}/officers", produces = {"application/json"},
...
public class OfficerFilingControllerImpl implements OfficerFilingController {
    ...
    @Override
    @PostMapping
    public ResponseEntity<Object> createFiling(@RequestBody @Valid @NotNull OfficerFilingDto dto,
