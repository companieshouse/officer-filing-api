...
public interface OfficerFilingMapper {
    ...
    @Mapping(target = "data.isMailingIsMailingAddressSameAsRegisteredOfficeAddress", source = "isMailingIsMailingAddressSameAsRegisteredOfficeAddress")
    ...
    @Mapping(target = "data.directorCorrespondenceAddressChoice", source = "directorCorrespondenceAddressChoice")
    @Mapping(target = "data.isMailingAddressSameAsHomeAddress", source = "isMailingAddressSameAsHomeAddress")
    ...
    @Mapping(target = "isMailingIsMailingAddressSameAsRegisteredOfficeAddress", source = "data.isMailingIsMailingAddressSameAsRegisteredOfficeAddress")
    ...
    @Mapping(target = "directorCorrespondenceAddressChoice", source = "data.directorCorrespondenceAddressChoice")
    @Mapping(target = "isMailingAddressSameAsHomeAddress", source = "data.isMailingAddressSameAsHomeAddress")
