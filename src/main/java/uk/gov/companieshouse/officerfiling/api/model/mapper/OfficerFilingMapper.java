...
public interface OfficerFilingMapper {
    ...
    @Mapping(target = "data.isMailingAddressSameAsRegisteredOfficeAddress", source = "isMailingAddressSameAsRegisteredOfficeAddress")
    ...
    @Mapping(target = "isMailingAddressSameAsRegisteredOfficeAddress", source = "data.isMailingAddressSameAsRegisteredOfficeAddress")
